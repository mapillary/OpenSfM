...
bundle_use_gcp: yes                   # Enforce Ground Control Point position in bundle adjustment
bundle_compensate_gps_bias: yes       # Compensate GPS with a per-camera similarity transform
