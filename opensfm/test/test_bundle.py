...
def test_sigleton():
    ...
    sa.add_absolute_position('1', [1, 0, 0], 1)
...
def test_pair():
    ...
    sa.add_absolute_position('1', [0, 0, 0], 1)
...
def test_four_cams_single_reconstruction():
    ...
    sa.add_absolute_position('1', [0, 0, 0], 1)
    sa.add_absolute_position('2', [2, 0, 0], 1)
    sa.add_absolute_position('3', [0, 2, 0], 1)
...
def test_four_cams_single_reconstruction_non_rigid():
    ...
    sa.add_absolute_position('1', [0, 0, 0], 1)
    sa.add_absolute_position('2', [2, 0, 0], 1)
    sa.add_absolute_position('3', [4, 2, 0], 1)
    sa.add_absolute_position('4', [4, 4, 0], 1)
...
def test_four_cams_one_fixed():
    ...
    sa.add_relative_motion(csfm.BARelativeMotion('1234', '1', '1234', '3', [0, 0, 0], [0, -1, 0]))
    sa.add_relative_motion(csfm.BARelativeMotion('1234', '1', '1234', '4', [0, 0, 0], [0, 0, -1]))
    sa.add_absolute_position('1', [100, 0, 0], 1)
    sa.add_absolute_position('2', [2, 0, 0], 1)
    sa.add_absolute_position('3', [0, 2, 0], 1)
...
def test_linear_motion_prior_position():
    ...
    sa.add_absolute_position('1', [0, 0, 0], 1)
    sa.add_absolute_position('3', [2, 0, 0], 1)
