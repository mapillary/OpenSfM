...
def test_shot_sfm():
    ...
    # test getters
    assert map_shot1 == m.get_shot("shot1") and map_shot2 == m.get_shot("shot2")
...
def test_map():
    ...
    assert m.number_of_landmarks() == n_landmarks and m.number_of_cameras() == n_cams and m.number_of_shots() == n_shots
    n_total_obs = 0
...
# test_pose_minimal_representation()
# test_camera()
# test_shot_sfm()
# test_points()
test_map()
