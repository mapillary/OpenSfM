...
TEST(Camera, TestCameraProjectionTypes) {
  ASSERT_EQ(geometry::Camera::GetProjectionString(
                geometry::camera::ProjectionType::BROWN),
            "brown");
  ASSERT_EQ(geometry::Camera::GetProjectionString(
                geometry::camera::ProjectionType::PERSPECTIVE),
            "perspective");
  ASSERT_EQ(geometry::Camera::GetProjectionString(
                geometry::camera::ProjectionType::DUAL),
            "dual");
  ASSERT_EQ(geometry::Camera::GetProjectionString(
                geometry::camera::ProjectionType::FISHEYE),
            "fisheye");
  ASSERT_EQ(geometry::Camera::GetProjectionString(
                geometry::camera::ProjectionType::FISHEYE_OPENCV),
            "fisheye_opencv");
  ASSERT_EQ(geometry::Camera::GetProjectionString(
                geometry::camera::ProjectionType::FISHEYE62),
            "fisheye62");
  ASSERT_EQ(geometry::Camera::GetProjectionString(
                geometry::camera::ProjectionType::SPHERICAL),
            "spherical");
  ASSERT_EQ(geometry::Camera::GetProjectionString(
                geometry::camera::ProjectionType::RADIAL),
            "radial");
  ASSERT_EQ(geometry::Camera::GetProjectionString(
                geometry::camera::ProjectionType::SIMPLE_RADIAL),
            "simple_radial");
