...
PYBIND11_MODULE(pygeometry, m) {
  py::enum_<geometry::camera::ProjectionType>(m, "ProjectionType")
      .value("PERSPECTIVE", geometry::camera::ProjectionType::PERSPECTIVE)
      .value("BROWN", geometry::camera::ProjectionType::BROWN)
      .value("FISHEYE", geometry::camera::ProjectionType::FISHEYE)
      .value("FISHEYE_OPENCV", geometry::camera::ProjectionType::FISHEYE_OPENCV)
      .value("FISHEYE62", geometry::camera::ProjectionType::FISHEYE62)
      .value("DUAL", geometry::camera::ProjectionType::DUAL)
      .value("SPHERICAL", geometry::camera::ProjectionType::SPHERICAL)
      .value("RADIAL", geometry::camera::ProjectionType::RADIAL)
      .value("SIMPLE_RADIAL", geometry::camera::ProjectionType::SIMPLE_RADIAL)
      .export_values();
  ...
  py::class_<geometry::Camera>(m, "Camera")
      ...
      .def(py::pickle(
          ...
          [](py::tuple t) {
            ...
            const auto type = t[2].cast<geometry::camera::ProjectionType>();
