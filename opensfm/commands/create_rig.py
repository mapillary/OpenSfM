...
class Command(command.CommandBase):
    name = "create_rig"
    help = "Create rig by creating `rig_models.json` and `rig_assignments.json` files."
    ...
    def add_arguments_impl(self, parser):
        ...
        parser.add_argument(
            "definition",
            help=(
                "Defines each RigModel as a JSON string dict with the form `{rig_model_id_1: {camera_id_1: definition, ...}}`"
